...
## About
This is an android based application that connects to a companion sensor device via Bluetooth to provide real-time, high-frequency monitoring of air quality as well as alarms for indicators that fall below safety or health standards. Users can decide to be alarmed in different ways. You can find the Landing Page ![here](https://github.com/Hypersaki/casa0015-mobile-assessment/blob/main/airalarmlanding/landingpage.html)
